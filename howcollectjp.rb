...
@title = ""
@body = ""
@media_name = "howcollectjp"
@crawler_name = "howcollectjpRB"
@etc1 = ""
@etc5 = ""
...
while time < 935
	...
	begin
		@tempUrl = "http://howcollect.jp/list/index/category/1/?page=#{time}/"
		doc = Nokogiri.HTML(open(@tempUrl, :ssl_verify_mode => OpenSSL::SSL::VERIFY_NONE).read)

		doc.xpath("//li[@class='line-article']/a").each do |u|
			@url =  "http://howcollect.jp" + u["href"] 
			puts @url
			begin
				sleep(2)
